...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    static public final String ACTION_SHOW = "com.stringmanolo.hackerskeyboard.SHOW";
    static public final String ACTION_SETTINGS = "com.stringmanolo.hackerskeyboard.SETTINGS";
